...
from utils.plots import plot_one_box_Car, plot_one_box_Person, plot_one_box
from utils.torch_utils import select_device, load_classifier, time_synchronized,plot_dots_on_people,plot_dots_on_car,distancing
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        #
                        # ###########################add safe distance of the person and car
                        ...
                        #     if (label.split())[0] == 'bus' or (label.split())[0] == 'car' :
...
if __name__ == '__main__':
    ...
    opt = parser.parse_args()  #parsed parameter
    print(opt)
